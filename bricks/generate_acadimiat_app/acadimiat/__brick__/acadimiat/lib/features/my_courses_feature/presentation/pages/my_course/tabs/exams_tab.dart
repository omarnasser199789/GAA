...
class ExamsTab extends StatefulWidget {
  const ExamsTab({Key? key,required this.quizz}) : super(key: key);
                  ...
                  child: Container(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: Theme
                              .of(context)
                              .cardColor
                              .withOpacity(0.1), //Colors.grey.withOpacity(0.1),
                          spreadRadius: 5,
                          blurRadius: 7,
                          offset: const Offset(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(
                          left: 13, right: 13, bottom: 12, top: 12),
                      child: Row(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "عدد مرات المحاولة المسموحة :  ${widget
                                      .quizz[index].attempts}",
                                  style: blackBoldTextStyle(context: context,
                                      fontSize: 11),
                                ),
                              )
