          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(left: 9, right: 9, top: 13),
                  child: Column(
                    mainAxisAlignment:
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          CustomButton(
                            ...
                            height: 25,
                            fontSize: 12,
                            textColor: const Color.fromRGBO(38, 96, 164, 1),
                            color: const Color.fromRGBO(38, 96, 164, 0.1),
                          ),
                          SizedBox(
                              width: 40,
                              height: 40,
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: blackBoldTextStyle(fontSize: 11, height: 2, context:context),
                        ),
                      ),
                      Padding(
                        padding:
                        const EdgeInsets.only(top: 5, bottom: 14),
                        child: Text(
                          "25.06.2022 10:00",
                          style: blackBoldTextStyle(fontSize: 11, height: 2, context:context),
                        ),
