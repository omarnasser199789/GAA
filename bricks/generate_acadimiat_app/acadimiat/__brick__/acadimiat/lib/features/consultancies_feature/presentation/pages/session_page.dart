                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              // Text(consultationSessionList[index].url,style: blackBoldTextStyle(fontSize: 10,context: context,)),

                                              if (!consultationSessionList[index].isDone &&
                                                  (consultationSessionList[index]
                                                          .url !=
                                                      ""))
                                                Padding(
                                                  padding:
                                              ...
                                              if (consultationSessionList[index]
                                                  .isDone)
                                                Padding(
                                                  padding:
                                                  ...
                                                  child: CustomButton(
                                                    ...
                                                    onTap: () async {
                                                      ...
                                                      // }
                                                      // goTo(context, (context) => FlutterBrowserApp(
                                                      //   // url: consultationSessionList[index].url,
                                                      // ));
                                                    },
                                                  ),
                                                ),
