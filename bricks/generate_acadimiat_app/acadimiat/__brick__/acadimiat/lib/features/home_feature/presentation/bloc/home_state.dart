...
class CardByIdLoaded extends HomeState {
  ...
  CardByIdLoaded(
      {required this.cardByIdEntity}); //we use this constructor in ((BLOC & test))
...
class CategoriesIsLoaded extends HomeState {
  ...
  CategoriesIsLoaded(
      {required this.categoriesEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetPackage extends HomeState {
  ...
  SuccessGetPackage(
      {required this.packageEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetDiplomasAndPackagesFromLocaleDB extends HomeState {
  ...
  SuccessGetDiplomasAndPackagesFromLocaleDB(
      {required this.diplomasAndPackagesEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetConsultanciesFromLocalDB extends HomeState {
  ...
  SuccessGetConsultanciesFromLocalDB(
      {required this.consultanciesFromLocalDbEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetCategoriesFromLocalDB extends HomeState {
  ...
  SuccessGetCategoriesFromLocalDB(
      {required this.categoriesFromLocalDBEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetAllProductsFromFav extends HomeState {
  ...
  SuccessGetAllProductsFromFav(
      {required this.favEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetTrainingCourses extends HomeState {
  ...
  SuccessGetTrainingCourses(
      {required this.trainingCoursesEntity}); //we use this constructor in ((BLOC & test))
...
class SuccessGetSearchItem extends HomeState {
  ...
  SuccessGetSearchItem(
      {required this.list}); //we use this constructor in ((BLOC & test))
...
class SuccessUpdateDiplomasAndPackages extends HomeState {
  ...
  SuccessUpdateDiplomasAndPackages(
      {required this.statesCode}); //we use this constructor in ((BLOC & test))

}

class SuccessDeleteProductToFavLocalDB extends HomeState {
    final int statesCode; //Entities form domain
  SuccessDeleteProductToFavLocalDB(
      {required this.statesCode}); //we use this constructor in ((BLOC & test))
...
class SuccessGetBanners extends HomeState {
    ...
    SuccessGetBanners(
      {required this.banners}); //we use this constructor in ((BLOC & test))
...
class latestIsLoaded extends HomeState {
  ...
  latestIsLoaded(
      {required this.latestEntity}); //we use this constructor in ((BLOC & test))
...
class ConsultanciesIsLoaded extends HomeState {
  ...
  ConsultanciesIsLoaded(
      {required this.consultanciesEntity}); //we use this constructor in ((BLOC & test))
